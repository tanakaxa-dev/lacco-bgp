...
ok: [tanakaxa-ix] => {
    "msg": [
        "Sunday, 16 June 2019 18:19:13 +09 00"
    ]
}
...
ok: [tanakaxa-ix] => {
    "msg": [
        "BGP table version is 152, local router ID is 172.18.19.1",
        ...
        "*                     172.18.18.1                            64512 64515 i",
        "*> 172.18.20.48/28    172.18.18.6                            64514 64515 i",
        "*                     172.18.18.1                            64512 64515 i",
...
ok: [tanakaxa-cis] => {
    "msg": [
        "18:19:05.804 JST Sun Jun 16 2019"
    ]
}
...
ok: [tanakaxa-cis] => {
    "msg": [
        "BGP table version is 171, local router ID is 172.18.19.5",
        ...
        " *>   172.18.20.48/28  172.18.20.1                            0 64515 i",
