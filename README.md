...
ok: [tanakaxa-ix] => {
    "msg": [
        "Sunday, 16 June 2019 12:20:12 +09 00"
    ]
}
...
ok: [tanakaxa-ix] => {
    "msg": [
        "BGP table version is 134, local router ID is 172.18.19.1",
        ...
        "*> 172.18.20.16/28    172.18.18.1                            64512 64516 64515 i",
...
ok: [tanakaxa-cis] => {
    "msg": [
        "12:20:06.793 JST Sun Jun 16 2019"
    ]
}
...
ok: [tanakaxa-cis] => {
    "msg": [
        "BGP table version is 148, local router ID is 172.18.19.5",
        ...
        " *>   172.18.20.16/28  172.18.18.5                            0 64513 64512 64516 64515 i",
